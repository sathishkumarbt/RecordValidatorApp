...
public class UniqueTransactionReferenceValidatorTest  {
    private static IStatementRecordValidator uniqueTranacationRefValidator;

    @BeforeAll
    static void setup() {
        uniqueTranacationRefValidator = new UniqueTransactionReferenceValidator();
    }
    ...
    public void testListOfDuplicateReference(){
        ...
        List<MT940> errorRecords = uniqueTranacationRefValidator.validate(records);
